  ...
  return (
    <div>
      <article className="mt-15 p-3">
        <h1 className=" text-2xl mb-3"> <strong> Fuel Combustion Carbon Calculator</strong></h1>
        <p>This particular carbon calculator will provide carbon emissions in grams, kilograms and pounds. To be able to calculate a fuel combustion carbon emission estimate, provide the following parameters: </p> <br />
        <ul className="mb-3">
          <li> <i> Fuel Source Type:</i> &nbsp;&nbsp;&nbsp;&nbsp; Provide the api name of the fuel source you want to calculate combustion emissions from.</li>
          <li> <i> Fuel Source Unit:</i> &nbsp;&nbsp;&nbsp;&nbsp; Input the units of the fuel source. Units are specific to <em>fuel source type</em>  view units in table below</li>
          <li> <i> Fuel Source Value:</i> &nbsp;&nbsp;&nbsp;&nbsp; Amount of the above specific unit and fuel source that you want an emissions estimate for.</li>
          <li> <i> Type:</i> &nbsp;&nbsp;&nbsp;&nbsp; In type input enter <strong>fuel_combustion</strong> given that it is a fuel combustion calculator</li>
        </ul>
        <center>
        <table className="border-separate border border-slate-400 ... ">
        <tbody>
            <tr>
            <th className="border border-slate-300 ...">Fuel Source name</th>
            <th className="border border-slate-300 ...">api_name</th>
            <th className="border border-slate-300 ...">Units(Choose One)</th>
            </tr>
            <tr>
      ...
      <form onSubmit={submission}>
        <div>
          <input className="border border-gray-300 rounded-lg bg-gray-50 mr-10 ml-8 p-3"
            type="text"
          ...
          />
          <input className="border border-gray-300 rounded-lg bg-gray-50 mr-10 ml-8 mt-5 p-3"
            type="text"
            value={type}
        ...
        <button className="submit-button rounded-md shadow-lg shadow-indigo-500/50 bg-green-600 hover:bg-amber-300 active:bg-green-700 focus:outline-none focus:ring focus:ring-amber-300 ... mt-10 mb-10 p-3" type="submit">
          Estimate
        </button>
      </form>
